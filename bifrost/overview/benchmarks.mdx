---
title: "Benchmarks"
description: "Bifrost has been tested under high load conditions to ensure optimal performance. The following results were obtained from benchmark tests running at 5000 requests per second (RPS) on different AWS EC2 instances."
---
...
**Curious how we handle scales of 10k\+ RPS?** Check out our [System Architecture Documentation](/bifrost/architecture/system-overview) for detailed insights into Bifrost's high-performance design, memory management, and scaling strategies.

- [**🌐 System Overview**](/bifrost/architecture/system-overview) - High-level architecture components
- [**🔄 Request Flow**](/bifrost/architecture/request-flow) - Request processing pipeline
- [**⚙️ Concurrency Model**](/bifrost/architecture/concurrency) - Worker pools and threading details
- [**💡 Design Decisions**](/bifrost/architecture/design-decision) - Performance-related architectural choices