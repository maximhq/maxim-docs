...
| Task                            | Go Here                                                                            |
| ------------------------------- | ---------------------------------------------------------------------------------- |
| **Get started in 30 seconds**   | [Quick Start](/bifrost/quickstart/overview)                                        |
...
### [Quick Start](/bifrost/quickstart/overview)
...
- [**30-Second Setup**](/bifrost/quickstart/overview) - Get started immediately
