...
| [**⚙️ Concurrency**](/bifrost/architecture/concurrency)   | Worker pools & threading model              | Goroutines, channels, resource isolation |
...
| [**🛠️ MCP System**](/bifrost/architecture/mcp)                  | Model Context Protocol internals    | Tool discovery, execution, integration  |
...
**💡 New to Bifrost architecture?** Start with [**System Overview**](/bifrost/architecture/system-overview) for the complete picture, then dive into [**Request Flow**](/bifrost/architecture/request-flow) to understand how it all works together.