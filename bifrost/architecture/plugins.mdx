...
> **Plugin Configuration:** [Plugin Setup →](/bifrost/usage/http-transport/configuration/plugins)
...
> **Integration Examples:** [Plugin Development Guide →](/bifrost/usage/go-package/plugins)

**Next Step:** Learn about the MCP (Model Context Protocol) system architecture in [**MCP System**](/bifrost/architecture/mcp).