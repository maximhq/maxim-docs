...
description: "Comprehensive guide for building powerful Bifrost plugins. Learn how to create PreHook and PostHook plugins that extend Bifrost's request/response pipeline with custom logic."
---

### ⚠️ IMPORTANT: Before developing a plugin, thoroughly read the [Plugin Architecture Documentation](/bifrost/architecture/plugins) to understand:
