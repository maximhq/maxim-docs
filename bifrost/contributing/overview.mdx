...
- Read the [Code Conventions](/bifrost/contributing/code-conventions)
...
| ------------------------- | -------------- | ----------------- | ------------------------------------------------------------- |
| **🌐 New Providers**      | Advanced       | 4-8 hours         | [Provider Guide →](/bifrost/contributing/provider)            |
| **🔌 Plugin Development** | Intermediate   | 2-6 hours         | [Plugin Guide →](/bifrost/contributing/plugin)                |
| **🌍 HTTP Integrations**  | Advanced       | 6-12 hours        | [Integration Guide →](/bifrost/contributing/http-integration) |
