---
title: "HTTP Integration Development Guide"
description: "Comprehensive guide for building HTTP integrations for Bifrost. Learn how to create new API-compatible endpoints that translate between external service formats and Bifrost's unified interface."
---

> **⚠️ IMPORTANT**: Before developing an integration, **thoroughly read** the [Request Flow Documentation](/bifrost/architecture/request-flow) and [System Overview](/bifrost/architecture/system-overview) to understand:
>
