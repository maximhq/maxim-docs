...
description: "Get Bifrost running as an HTTP API in 30 seconds using Docker. Perfect for any programming language."
---
...
| ------------------------------ | -------------------------------------------------------------------------------- | --------- |
| **Drop-in integrations guide** | [🔄 Integrations](/bifrost/usage/http-transport/integrations/overview)           | 5 min     |
| **Complete HTTP setup**        | [📖 HTTP Transport Usage](/bifrost/usage/http-transport/configuration/providers) | 10 min    |
| **Production configuration**   | [🔧 Configuration](/bifrost/usage/http-transport/configuration/plugins)          | 15 min    |
| **All endpoints**              | [🎯 API Endpoints](/bifrost/usage/http-transport/endpoints)                      | Reference |
| **OpenAPI specification**      | [📊 OpenAPI Spec](/bifrost/usage/http-transport/openapi.json)                    | Reference |

## Prefer Go Package?

If you're building a Go application and want direct integration, try the [**Go Package Quick Start**](/bifrost/quickstart/go-package) instead.
