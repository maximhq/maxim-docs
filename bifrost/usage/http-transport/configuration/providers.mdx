...
description: "Complete guide to configuring AI providers in Bifrost HTTP transport through config.json."
---
...
**🏛️ Architecture:** For provider selection algorithms and load balancing, see [Architecture Documentation](/bifrost/architecture/overview).