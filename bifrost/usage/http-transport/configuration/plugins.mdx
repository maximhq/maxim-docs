...
**Architecture:** For plugin system design and performance details, see [Architecture Documentation](/bifrost/architecture/overview).

**Development:** Full plugin development guide and examples available in [Go Package Plugins](/bifrost/usage/go-package/plugins).