...
description: "Complete guide to using Bifrost as a drop-in replacement for existing AI provider APIs with zero code changes."
---
...
- [**📖 OpenAI Integration Guide**](/bifrost/usage/http-transport/integrations/openai-compatible)
...
- [**📖 Anthropic Integration Guide**](/bifrost/usage/http-transport/integrations/anthropic-compatible)
...
- Content filtering
- [**📖 GenAI Integration Guide**](/bifrost/usage/http-transport/integrations/genai-compatible)
...
- [**📖 Complete Migration Guide**](/bifrost/usage/http-transport/integrations/migration-guide)

**Architecture:** For integration design patterns and performance details, see [Architecture Documentation](/bifrost/architecture/overview).