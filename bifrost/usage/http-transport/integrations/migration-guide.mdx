...
description: "Step-by-step guide to migrate from existing AI provider APIs to Bifrost for improved reliability, cost optimization, and enhanced features."
---
...
- [OpenAI Compatible](/bifrost/usage/http-transport/integrations/openai-compatible)
- [Anthropic Compatible](/bifrost/usage/http-transport/integrations/anthropic-compatible)
- [GenAI Compatible](/bifrost/usage/http-transport/integrations/genai-compatible)
...
**Architecture:** For migration architecture patterns and best practices, see [Architecture Documentation](/bifrost/architecture/overview).