---
title: "Google GenAI Compatible API"
description: "Complete guide to using Bifrost as a drop-in replacement for Google GenAI API with full compatibility and enhanced features."
---
...
**🏛️ Architecture:** For Google GenAI integration implementation details, see [Architecture Documentation](/bifrost/architecture/overview).