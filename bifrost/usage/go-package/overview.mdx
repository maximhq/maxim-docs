...
| -------------------------------------------- | -------------------------------------------- | ------------- |
| [**Account Interface**](./account.md)    | Provider configuration and key management    | 5 min         |
...
| [**MCP Integration**](./mcp.md)          | Tool calling and external integrations       | 15 min        |
...
> **Deep Architecture:** For system internals, worker design, and performance details, see [Architecture Documentation](../../architecture/).
