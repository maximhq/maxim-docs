---
title: "Schemas"
description: "Data structures, interfaces, and type definitions reference for Bifrost Go package."
---
...
- **[Account Interface](./account.md)** - Account schema implementation
- **[Plugins](./plugins.md)** - Plugin schema implementation
- **[MCP Integration](./mcp.md)** - MCP schema usage
