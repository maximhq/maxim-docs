...
description: "Complete guide to using Model Context Protocol (MCP) integration for tool calling, external API connections, and custom tool registration in Bifrost."
---
...
> **Architecture:** For MCP system design and integration details, see [Architecture Documentation](../../architecture/).