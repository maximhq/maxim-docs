...
description:
    'Advanced API key management with weighted distribution, automatic rotation, and model-specific
    assignments across all providers.'
---
...
> **💡 Tip:** Use weights that sum to 1.0 for easier percentage calculations, but Bifrost
