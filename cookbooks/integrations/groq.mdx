...
<MaximPlayer url="https://www.youtube.com/embed/Zuu722fWqpg?si=wMy-mY0nUgyyCvex" />
...
```
![](/images/groq_tesla.png)

Stock Comparison Plot:

![](/images/groq_comparison.png)

## Maxim Observability

![](/images/groq_fin_maxim.gif)
...
<CardGroup cols="1">
    <Card title="Cookbook Code" icon="github" href="https://github.com/maximhq/maxim-cookbooks/blob/main/python/observability-online-eval/groq/groq.ipynb">
