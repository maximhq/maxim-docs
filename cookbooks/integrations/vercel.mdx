...
For more details, see the [Maxim JS SDK documentation](https://www.npmjs.com/package/@maximai/maxim-js) and the [Vercel AI SDK documentation](https://sdk.vercel.ai/docs).