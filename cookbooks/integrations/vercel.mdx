...
description: Learn how to add Maxim observability and tracing to your Vercel AI SDK applications in just one line of code.
---

# Maxim Observability with Vercel AI SDK
...
For more details, see the [Maxim JS SDK documentation](https://docs.maxim.ai/sdk/js/overview/) and the [Vercel AI SDK documentation](https://sdk.vercel.ai/docs). 