...
Each reasoning step, tool call, and answer is now visible as a trace and spans in your [Maxim dashboard](https://app.maxim.ai/).

---

For more details, see the [Maxim Python SDK documentation](https://docs.maxim.ai/sdk/python/overview/). 