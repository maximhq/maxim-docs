...
- Python >= 3.10
- A Maxim account ([sign up here](https://app.maxim.ai/))
- Maxim API Key ([generate here](https://app.maxim.ai/settings/api-keys))
...
- Log in to your [Maxim Dashboard](https://app.maxim.ai/)
...
![CrewAI traces in Maxim](crewai_traces.gif)
...
For more details, see the [CrewAI documentation](https://docs.crewai.com/) and the [Maxim Python SDK documentation](https://docs.maxim.ai/sdk/python/overview/). 