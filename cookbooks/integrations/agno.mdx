...
In this cookbook, you'll learn how to build a multi-agent financial conversational assistant using [Agno](https://github.com/agnodice/agno) for agent orchestration and [Maxim](https://docs.maxim.ai/) for observability and tracing. The agent can answer questions about stocks, companies, and financial data by leveraging both web search and financial data tools, with all interactions traced in Maxim.
...
For more details, see the [Agno documentation](https://github.com/agnodice/agno) and the [Maxim Python SDK documentation](https://docs.maxim.ai/sdk/python/overview/). 