...
<CardGroup cols={2}>
  <Card title="Vercel AI SDK" icon="vercel" href="https://ai-sdk.dev/docs/introduction">
    
  </Card>
  <Card title="Vercel Maxim Example" icon="javascript" href="https://github.com/akmadan/vercel-maxim">
