...
description: "Learn how to integrate Maxim observability with the Vercel AI SDK in just one line of code."
---
...
![Gif](https://example.com/vercel-ai-sdk-traces.gif)

## Resources

<CardGroup cols={2}>
  <Card title="Vercel AI SDK Integration Examples" icon="vercel" href="https://github.com/maxim-ai/examples/vercel-ai-sdk">
    
  </Card>
  <Card title="Next.js Chatbot Example" icon="nextdotjs" href="https://github.com/maxim-ai/examples/nextjs-chatbot">
