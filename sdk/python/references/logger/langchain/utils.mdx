# maxim.logger.langchain.utils

#### parse\_langchain\_provider

[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/langchain/utils.py#L23)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/langchain/utils.py#L53)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/langchain/utils.py#L73)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/langchain/utils.py#L98)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/langchain/utils.py#L121)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/langchain/utils.py#L319)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/langchain/utils.py#L341)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/langchain/utils.py#L451)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/langchain/utils.py#L486)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/langchain/utils.py#L521)
