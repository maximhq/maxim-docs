# maxim.logger.livekit.utils

## [SameThreadExecutor](/sdk/python/references/logger/livekit/utils)

[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/livekit/utils.py#L17)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/livekit/utils.py#L59)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/livekit/utils.py#L66)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/livekit/utils.py#L75)
