# maxim.logger.anthropic.client

## [MaximAnthropicClient](/sdk/python/references/logger/anthropic/client)

[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/anthropic/client.py#L10)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/anthropic/client.py#L22)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/anthropic/client.py#L34)
