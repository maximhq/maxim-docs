# maxim.logger.anthropic.stream\_manager

## [TextStreamWrapper](/sdk/python/references/logger/anthropic/stream_manager)

[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/anthropic/stream_manager.py#L10)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/anthropic/stream_manager.py#L22)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/anthropic/stream_manager.py#L32)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/anthropic/stream_manager.py#L40)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/anthropic/stream_manager.py#L61)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/anthropic/stream_manager.py#L98)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/anthropic/stream_manager.py#L166)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/logger/anthropic/stream_manager.py#L213)
