# maxim.dataset.dataset

#### create\_data\_structure

[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/dataset/dataset.py#L12)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/dataset/dataset.py#L33)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/dataset/dataset.py#L82)
