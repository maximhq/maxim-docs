# maxim.models.evaluator

## [Evaluator](/sdk/python/references/models/evaluator)

[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/models/evaluator.py#L17)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/models/evaluator.py#L69)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/models/evaluator.py#L77)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/models/evaluator.py#L122)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/models/evaluator.py#L177)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/models/evaluator.py#L243)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/models/evaluator.py#L304)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/models/evaluator.py#L359)
...
[View source on GitHub](https://github.com/maximhq/maxim-py/blob/main/maxim/models/evaluator.py#L423)
