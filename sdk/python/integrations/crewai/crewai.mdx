...
description: "Start Agent monitoring, evaluation, and observability for your CrewAI applications"
---

import { MaximPlayer } from "/snippets/maximPlayer.mdx"

<MaximPlayer url="https://www.youtube.com/embed/ljWDBCypVYM?si=2mgMyiKFipvOsomy" />
...
<Tabs>
  ...
  <Tab title="Alerting">
    ...
    ![maxim_alerts_1.png](/images/maxim_alerts_1.png)
  </Tab>
