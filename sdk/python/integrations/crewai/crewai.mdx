...
<Tabs>
  <Tab title="Prompt Playground">
    ...
    ![maxim_playground.png](/images/maxim_playground.png)
  </Tab>
  <Tab title="Prompt Versions">
    ...
    ![maxim_versions.png](/images/maxim_versions.png)
  </Tab>
...
<Tabs>
  <Tab title="Agent Tracing">
    ...
    ![maxim_agent_tracking.png](/images/maxim_agent_tracking.png)
  </Tab>
  <Tab title="Analytics + Evals">
    ...
    ![maxim_trace_eval.png](/images/maxim_trace_eval.png)
...
<CardGroup cols="3">
  <Card title="CrewAI Docs" icon="book" href="https://docs.crewai.com/">
    <p>
    Official CrewAI documentation</p>
  </Card>
  <Card title="Maxim Docs" icon="book" href="https://getmaxim.ai/docs">
    <p>
    Official Maxim documentation</p>
  </Card>
  <Card title="Maxim Github" icon="github" href="https://github.com/maximhq">
    <p>
    Official CrewAI documentation</p>
  </Card>
  <Card title="Book a Demo" icon="calendar" href="https://www.getmaxim.ai/demo">
    <p>
    Get personalized guidance on implementing this integration</p>
  </Card>
</CardGroup>