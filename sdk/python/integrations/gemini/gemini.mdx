...
- **Function Calling**: Native support for Gemini function calling capabilities
- **System Instructions**: Support for system-level instructions
- **Temperature Control**: Fine-tune response creativity with temperature settings
