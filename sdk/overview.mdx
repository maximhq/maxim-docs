...
<CardGroup cols={2}>
  <Card title="Prompt management using Maxim" icon="terminal" href="/docs/evaluate/how-to/evaluate-prompts/deploy-prompts">
    
  </Card>
  <Card title="Dataset management using Maxim" icon="table" href="/docs/library/how-to/datasets/add-new-entries-using-sdk">
    
  </Card>
  <Card title="Observe and evaluate your production logs realtime using Maxim." icon="tower-observation" href="/docs/observe/overview">
