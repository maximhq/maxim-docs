...
<Note>
Learn how to track complete LLM flows in the [LLM logging guide](/observe/how-to/log-your-application/adding-llm-call).
</Note>
...
<Note>
Explore more on tool call tracking in the [Tool calls logging guide](/observe/how-to/log-your-application/track-tool-calls).
</Note>
