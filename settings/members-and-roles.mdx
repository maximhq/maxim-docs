...
You can edit the permissions of any of the inbuilt roles or even create a custom role by clicking `Create role`.
Once done, you can customise the set of permissions for that role.

![Customize Roles](/images/docs/settings/customise_roles.png)

<Note>You cannot edit the name of inbuilt roles.</Note>
