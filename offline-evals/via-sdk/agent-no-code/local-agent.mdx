...
description: Learn how to create and evaluate custom AI agents using local execution via Maxim SDK
---
...
- [Evaluators Documentation](/library/evaluators/overview) - Learn about different evaluation methods
