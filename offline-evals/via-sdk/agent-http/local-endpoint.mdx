...
description: Learn to evaluate AI agents hosted on your own local or private endpoints using the Maxim SDK. This page shows how to call your HTTP services for agent testing with complete flexibility.
---
