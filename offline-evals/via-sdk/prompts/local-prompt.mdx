...
description: This page shows how to run tests on prompts you define in your own code using the Maxim SDK. Learn to implement custom prompt logic and connect to any LLM provider locally.
---
