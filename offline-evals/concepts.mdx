---
title: Offline Evaluation Concepts
description: This page introduces the core concepts of offline evaluation in Maxim, including how prompts work, prompt comparisons, and best practices for leveraging these features to assess AI model performance. Learn about prompts, agents, workflows, test runs, evaluators, and datasets.
---

## What are Offline Evaluation Concepts

Offline evaluation in Maxim allows you to test and assess your AI applications before deployment. This section covers the key concepts you'll need to understand.
