...
You can find more about prompts [here](/prompt-engineering/prompt-playground).
...
You can find more about prompt comparisons [here](/prompt-engineering/prompt-playground#prompt-comparison).
...
You can find more about Maxim's [pre-built evaluators](/library/evaluators/pre-built-evaluators/overview) or [create your own](/library/evaluators/custom-evaluators)
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td colspan="2">You can find more about our evaluators [here](/library/evaluators/pre-built-evaluators/overview).</td>
    </tr>
  </tbody>
</table>
