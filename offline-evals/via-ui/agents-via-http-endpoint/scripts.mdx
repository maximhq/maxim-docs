---
title: Scripts
description: Learn how to use Workflow scripts to customize API request and response handling. This page shows how to transform data, set headers, and process results in Maxim HTTP endpoint agents.
---
