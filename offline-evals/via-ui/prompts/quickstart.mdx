...
Start by creating a new [Prompt](/offline-evals/via-ui/prompts/prompt-playground) in the playground. Configure your messages and settings, then [publish the version](/offline-evals/via-ui/prompts/prompt-versions) when you're ready for testing.
...
Choose a [Dataset](/library/datasets/import-or-create-datasets) with your test cases and add [Evaluators](/library/evaluators/pre-built-evaluators) to measure response quality. You can mix and match evaluators to check for accuracy, toxicity, and more.
