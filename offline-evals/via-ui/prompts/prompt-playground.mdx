...
description: Learn how to use the Prompt Playground to compare Prompts
---
...
If your prompts require tool usage, you can attach tools and experiment using `tool` type messages. [Learn about using tools in playground](/offline-evals/via-ui/prompts/prompt-tools).
...
- For agentic systems in which you want to test out correct tool usage by your prompt, learn about [running a prompt with tool calls](/offline-evals/via-ui/prompts/prompt-tools).
