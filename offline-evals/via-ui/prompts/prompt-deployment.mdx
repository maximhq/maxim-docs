...
<Steps>
    ...
    <Step title="Define variable properties">
        ...
        <img src="/images/docs/evaluate/how-to/evaluate-prompts/deployments/multiselect-deployment-rule.png" alt="Multiselect deployment rule" width="100%" className="max-w-full" />
    </Step>
