...
description: Discover how to integrate and use Model Context Protocol (MCP) servers in Maxim to test prompts with tool-assisted workflows. This page walks you through connecting MCP clients, adding tools, and leveraging agentic or non-agentic modes for prompt evaluation.
---
