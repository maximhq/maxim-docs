...
If you want to compare Prompt versions over time (e.g. Last month's scores and this month's scores post a Prompt iteration), you can instead [generate a comparison report retrospectively](/offline-evals/via-ui/prompts/prompt-playground#prompt-comparison) under the analyze section.
