...
description: Learn how to get started with your first evaluation run in Maxim
---
...
To learn more about evaluators, refer to our detailed guide on [Evaluators](/library/evaluators/use-pre-built-evaluators).
...
3. [Context sources](/library/context-sources/ingest-files-as-a-context-source): Integrate Retrieval-Augmented Generation (RAG) into your agent endpoints.
