...
### Custom Simulation
For advanced use cases, create simulations with your own custom prompt instructions, giving you full control over simulation agent behavior. Configure custom variables, use prompt partials, and define specific end conditions. [Learn more](/simulations/text-simulation/custom-simulation)
