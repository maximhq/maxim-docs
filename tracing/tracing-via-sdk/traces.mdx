---
title: Traces
description: Learn how to set up tracing using the Maxim platform. This guide covers the necessary steps to instrument your AI application and start monitoring and evaluating its performance.
---
...
![Traces](/images/docs/tracing/via-sdk/trace.png)
