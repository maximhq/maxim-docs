...
description: Learn how to track and log metrics from LLM generations, traces, retrievals, and sessions in your AI application to monitor performance, quality, and resource usage.
