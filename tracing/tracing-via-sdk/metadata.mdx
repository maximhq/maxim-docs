---
title: Metadata
description: Add custom key-value pairs to components for enhanced observability
---
...
# Add metadata after creation
trace.add_metadata({"custom_key": "custom_value","timestamp", "2024-01-01T00:00:00Z"})
```
...
```python Python
from maxim.logger import SpanConfig, EventConfig, RetrievalConfig
