---
title: Attachments
description: Learn how to attach files and URLs to traces and spans for richer observability in Maxim. Attachments let you add files (audio, images, text, etc.) or URLs to your traces and spans, providing extra context for debugging, analytics, and audit trails.
---
