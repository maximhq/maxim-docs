---
title: OpenTelemetry OTLP Ingest
...
- Your Log Repository ID (header `x-maxim-repo-id`).
...
Maxim currently supports traces that follow the OpenTelemetry Semantic Conventions for Generative AI ([spec](https://opentelemetry.io/docs/specs/semconv/gen-ai/)).

## Best Practices

- Use binary Protobuf (`application/x-protobuf`) for performance and robustness.
