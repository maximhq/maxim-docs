---
title: Dashboard
description: Learn how to use the dashboard to filter and sort your logs. Filter and sort your logs using custom criteria to streamline debugging and create saved views to quickly access your most-used search patterns.
---
