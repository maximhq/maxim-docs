...
<Note>
If you have OTel traces you would like to send to Maxim, you can use our endpoint: https://api.getmaxim.ai/v1/otel. This endpoint will convert the OTel traces to Maxim's format and ingest them into your repository. Make sure to include the header `x-maxim-repo-id` with your repository ID in your requests.
</Note>
