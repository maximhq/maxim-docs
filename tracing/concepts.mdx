...
description: Get a quick overview of Maxim's distributed tracing concepts for AI apps. Learn how logs, traces, and repositories enable deep monitoring, troubleshooting, and evaluation through Maxim's observability platform.
---
...
![Screenshot of overview metrics](/images/docs/tracing/tracing_overview.png)
...
We will talk more about evaluation logs in [How to evaluate logs](/online-evals/via-ui/set-up-auto-evaluation-on-logs) section of the documentation.
...
![Screenshot of the logs tab](/images/docs/tracing/logs_overview.png)
...
Learn more about logging in the [How to log your application](/tracing/tracing-via-sdk/traces) section of the documentation.
...
![Screenshot of the alerts tab](/images/docs/tracing/alerting_overview.png)

<Note>

You can learn more on configuring alerts in the [How to set up alerts](/online-evals/set-up-alerts-and-notifications) section of the documentation.
