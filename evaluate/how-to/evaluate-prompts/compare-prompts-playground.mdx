...
Choose Prompts from your existing [Prompts](/evaluate/how-to/evaluate-prompts/experiment-in-prompt-playground) or just select a model from the dropdown menu directly.
...
- [Compare results across test cases](/evaluate/how-to/evaluate-prompts/bulk-comparisons-across-test-cases)
