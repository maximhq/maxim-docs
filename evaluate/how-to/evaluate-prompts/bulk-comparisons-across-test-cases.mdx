...
If you want to compare Prompt versions over time (e.g. Last month's scores and this month's scores post a Prompt iteration), you can instead [generate a comparison report retrospectively](/analyze/how-to/comparison-reports) under the analyze section.

## Next steps
- [Create presets to re-use your test configurations](/evaluate/how-to/optimize-evaluation-processes/re-use-configuration-via-presets)
