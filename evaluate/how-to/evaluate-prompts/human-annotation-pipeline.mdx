...
<Steps>
<Step title="Creating human evaluators">
Add instructions, score type and pass criteria.
</Step>
<Step title="Select evaluators for test runs">
...
If there are particular cases where you would like to use the human corrected output to build ground truth in your datasets, you can use the [data curation flows.](/library/how-to/datasets/curate-golden-dataset-for-human-annotation)
