...
Run any [Prompt](/evaluate/how-to/evaluate-prompts/experiment-in-prompt-playground) as part of your workflow.
...
- [Run tests](/evaluate/how-to/evaluate-chains/test-prompt-chains)
- [Deploy to production](/evaluate/how-to/evaluate-chains/deploy-prompt-chains)
- [Access via SDK](/evaluate/how-to/evaluate-chains/querying-prompt-chains)

Learn more about [testing prompts](/evaluate/how-to/evaluate-prompts/bulk-comparisons-across-test-cases) or check our [SDK documentation](/sdk/overview).