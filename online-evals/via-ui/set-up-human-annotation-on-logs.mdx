...
![Screenshot of the evaluation configuration sheet](/images/docs/online-evals/via-ui/set-up-human-annotation-on-logs/screenshot-of-the-evaluation-configuration-sheet.png)

<Note>
We talked about the [Auto evaluation](/online-evals/via-ui/set-up-auto-evaluation-on-logs) section above. You can learn more about using other types of evaluators to evaluate your logs there.
</Note>
</Step>
...
![Screenshot of the annotation queue page](/images/docs/online-evals/via-ui/set-up-human-annotation-on-logs/screenshot-of-the-annotation-queue-page.png)
...
![Screenshot of queue logic setup form](/images/docs/online-evals/via-ui/set-up-human-annotation-on-logs/screenshot-of-queue-logic-setup-form.png)
</Step>
</Steps>
...
![Screenshot of the add to annotation queue button](/images/docs/online-evals/via-ui/set-up-human-annotation-on-logs/screenshot-of-the-add-to-annotation-queue-button.png)
</Note>
...
![Screenshot of the annotation queue page with scores](/images/docs/online-evals/via-ui/set-up-human-annotation-on-logs/screenshot-of-the-annotation-queue-page-with-scores.png)
...
![Screenshot of the annotation modal](/images/docs/online-evals/via-ui/set-up-human-annotation-on-logs/screenshot-of-the-annotation-modal.png)
...
![Screenshot of the annotation sheet view](/images/docs/online-evals/via-ui/set-up-human-annotation-on-logs/screenshot-of-the-annotation-sheet-view.png)
...
![Screenshot of the logs table with human evaluator scores](/images/docs/online-evals/via-ui/set-up-human-annotation-on-logs/screenshot-of-the-logs-table-with-human-evaluator-scores.png)
...
![Screenshot of the trace evaluation overview tab with rewritten outputs](/images/docs/online-evals/via-ui/set-up-human-annotation-on-logs/screenshot-of-the-trace-evaluation-overview-tab-with-rewritten-outputs.png)
...
![Screenshot of an individual human evaluator's evaluation with per user score breakdown](/images/docs/online-evals/via-ui/set-up-human-annotation-on-logs/screenshot-of-an-individual-human-evaluator_s-evaluation-with-per-user-score-breakdown.png)