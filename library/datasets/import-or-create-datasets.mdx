...
This combinator indicates that tool calls within this block can be executed in any order, and any such order will be considered a valid execution flow. All tool calls are mandatory here.
