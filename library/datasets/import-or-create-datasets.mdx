...
Scenarios are especially useful for simulating real-world conversations, testing agent behaviors, and ensuring your models handle a variety of user intents and contexts. Use this column when you are using this dataset for [agent simulation runs](/simulations/text-simulation/simulation-runs).
...
Tool calls can be provided as a single object or an array of objects. Below are the supported formats:
...
For `arguments` or `input` field, both parsed JSON object and stringified JSON are supported:
