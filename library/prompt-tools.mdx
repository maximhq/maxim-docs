---
title: Prompt Tools
description: This section includes comprehensive documentation for creating and using different types of prompt tools in Maxim. Learn how to create code-based, schema-based, and API-based tools to enhance your prompts with custom functions and agentic behaviors.
---
...
**Type:** Variables can be set as either string or number.

**Description:** Add a description for the variable to help the LLM understand its purpose.

**Optionality:** You can designate variables as optional or non-optional (required). The LLM uses this information, along with the user's prompt, to determine if it should include the variable in its function call.

You can add variables to your prompt tools by following the steps below:
...
<MaximPlayer url="https://drive.google.com/file/d/1K0Setmf5hEop3euIIljhALUqyeAlRLmR/preview"/>
...
<MaximPlayer url="https://drive.google.com/file/d/1XWxZBETWGOkvsbxLAdNjxP6QL9olQTiu/preview"/>
...
<MaximPlayer url="https://drive.google.com/file/d/12JinAFeGgwmfqtLT6rPA4MxxXC306xhY/preview"/>
