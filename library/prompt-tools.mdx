---
title: Prompt Tools
description: Comprehensive documentation for creating and using different types of prompt tools in Maxim. Learn how to create code-based, schema-based, and API-based tools to enhance your prompts with custom functions and agentic behaviors.
---
