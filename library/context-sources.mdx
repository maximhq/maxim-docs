...
description: Learn how to create, use, and evaluate context sources for your AI applications. Context sources in Maxim allow you to expose your RAG pipeline via a simple endpoint and link it as a variable in your prompts or endpoints for evaluation.
---
