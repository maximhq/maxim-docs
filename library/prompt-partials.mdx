---
title: Creating Prompt Partials
description: Learn how to create and use prompt partials in Maxim
---
...
[Add Partials to your Prompts](/offline-evals/via-ui/prompts/prompt-partials)