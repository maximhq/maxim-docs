...
For information on using context sources in agentic simulations and conversations, see our guide on [using context in prompts and workflows](/evaluate/how-to/evaluate-prompts/rag-quality).