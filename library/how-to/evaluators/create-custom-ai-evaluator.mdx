...
While Maxim offers a comprehensive set of evaluators in the [Store](/library/how-to/evaluators/use-pre-built-evaluators), you might need custom evaluators for specific use cases. Create your own AI evaluator by selecting an LLM as the judge and configuring custom evaluation instructions.
...
Convert your custom evaluator scores from a 1-5 scale to match Maxim's standard 0-1 scale. This helps align your custom evaluator with [pre-built evaluators](/library/how-to/evaluators/use-pre-built-evaluators) in the Store.
