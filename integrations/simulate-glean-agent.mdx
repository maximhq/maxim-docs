...
Create a new dataset with columns for:
- **scenario**: Description of what the agent should do
- **user_message**: The initial user message
- **expected_outcome** (optional): What you expect the agent to accomplish
- **context** (optional): Any additional context needed

Example dataset for a Customer Support agent:

| scenario | user_message | expected_outcome |
|----------|--------------|------------------|
| Refund request | "I need a refund for order #12345" | Agent verifies order and processes refund |
| Product inquiry | "What's the warranty on the iPhone 15?" | Agent provides accurate warranty information |
| Account update | "I need to change my billing address" | Agent guides through address update process |
